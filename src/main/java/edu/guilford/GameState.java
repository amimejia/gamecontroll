...
public class GameState {
    //Use an enum for a game state with initializing, runnning, paused and game over states
    public enum State {
        INITIALIZING, RUNNING, PAUSED, GAME_OVER
    }
    //enum is a collection of public static final cvalues
    ...
    //Declare a method to return the current game state
    public GameState() {
    ...
    public void startGame() {
        currentState = State.INITIALIZING;
        // current state is a variable of type State and can only have one of the four values in the enum
        //  current state = 1 doesn't work because currentSTate is not an int; it's a State variable which is an enum
    }
